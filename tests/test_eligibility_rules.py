...
def test_check_age_fails_below_minimum():
...
def test_check_age_fails_above_maximum():
...
def test_check_passport_passes():
...
def test_check_passport_fails_empty():
    """Empty string passport -> passed=False."""
    result = check_passport("")
    assert result["passed"] is False


def test_evaluate_all_all_passed():
...
def test_evaluate_all_some_failed():
...
def test_evaluate_all_with_max_age():
...
def test_get_actionable_feedback():
